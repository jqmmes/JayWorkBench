...
_JOBDETAILS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='JobDetails.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dataSize', full_name='JobDetails.dataSize', index=1,
...
_WORKER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='runningJobs', full_name='Worker.runningJobs', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='queuedJobs', full_name='Worker.queuedJobs', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='avgTimePerJob', full_name='Worker.avgTimePerJob', index=13,
...
_CALLRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='CallResponse.status', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bytes', full_name='CallResponse.bytes', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CALLRESPONSE.fields_by_name['status'].message_type = _STATUS
...
TaskExecutor = _reflection.GeneratedProtocolMessageType('TaskExecutor', (_message.Message,), dict(
...
TaskExecutors = _reflection.GeneratedProtocolMessageType('TaskExecutors', (_message.Message,), dict(
...
_SCHEDULERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='notifyJobComplete',
    full_name='SchedulerService.notifyJobComplete',
    index=1,
    containing_service=None,
    input_type=_JOBDETAILS,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
