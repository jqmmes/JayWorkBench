...
class BrokerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.executeJob = channel.unary_stream(
        ...
        request_serializer=JayProto__pb2.Job.SerializeToString,
        response_deserializer=JayProto__pb2.Results.FromString,
        )
    ...
    self.getModels = channel.unary_unary(
        ...
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=JayProto__pb2.Models.FromString,
        )
    self.setModel = channel.unary_unary(
        '/BrokerService/setModel',
        request_serializer=JayProto__pb2.Model.SerializeToString,
        response_deserializer=JayProto__pb2.Status.FromString,
        )
    ...
    self.callExecutorAction = channel.unary_unary(
        ...
        response_deserializer=JayProto__pb2.CallResponse.FromString,
        )
...
def add_BrokerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'executeJob': grpc.unary_stream_rpc_method_handler(
          servicer.executeJob,
          request_deserializer=JayProto__pb2.Job.FromString,
          response_serializer=JayProto__pb2.Results.SerializeToString,
      ),
      ...
      'getModels': grpc.unary_unary_rpc_method_handler(
          servicer.getModels,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=JayProto__pb2.Models.SerializeToString,
      ),
      'setModel': grpc.unary_unary_rpc_method_handler(
          servicer.setModel,
          request_deserializer=JayProto__pb2.Model.FromString,
          response_serializer=JayProto__pb2.Status.SerializeToString,
      ),
      ...
      'callExecutorAction': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=JayProto__pb2.CallResponse.SerializeToString,
      ),
...
class SchedulerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.schedule = channel.unary_unary(
        ...
        request_serializer=JayProto__pb2.JobDetails.SerializeToString,
        response_deserializer=JayProto__pb2.Worker.FromString,
        )
    self.notifyJobComplete = channel.unary_unary(
        '/SchedulerService/notifyJobComplete',
        request_serializer=JayProto__pb2.JobDetails.SerializeToString,
        response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
        )
...
class SchedulerServiceServicer(object):
  ...
  def notifyJobComplete(self, request, context):
    # missing associated documentation comment in .proto file
    pass
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
...
def add_SchedulerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'schedule': grpc.unary_unary_rpc_method_handler(
          servicer.schedule,
          request_deserializer=JayProto__pb2.JobDetails.FromString,
          response_serializer=JayProto__pb2.Worker.SerializeToString,
      ),
      'notifyJobComplete': grpc.unary_unary_rpc_method_handler(
          servicer.notifyJobComplete,
          request_deserializer=JayProto__pb2.JobDetails.FromString,
          response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
      ),
...
class WorkerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.execute = channel.unary_unary(
        ...
        request_serializer=JayProto__pb2.WorkerJob.SerializeToString,
        response_deserializer=JayProto__pb2.Results.FromString,
        )
...
def add_WorkerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'execute': grpc.unary_unary_rpc_method_handler(
          servicer.execute,
          request_deserializer=JayProto__pb2.WorkerJob.FromString,
          response_serializer=JayProto__pb2.Results.SerializeToString,
      ),
