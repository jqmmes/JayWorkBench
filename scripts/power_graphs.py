...
generation_deadlines = ["12_NO_DEADLINE"]#,"12_12", "12_9", "12_6", "12_3", "9_NO_DEADLINE","9_9", "9_6", "9_3", "6_NO_DEADLINE", "6_6", "6_3"]
#generation_deadlines = ["12_9"]
...
for group in groups:
    for gen in generation_deadlines:
        ...
        for rep in range(3):
            ...
            for file in sorted(files_tasks_generated.keys()):
                for task_id in files_tasks_generated[file]:
                    total_global_generated_tasks += 1
                    if task_id in files_tasks_executed[file]:
                        total_global_local_executions += 1
                    elif "cloudlet_192.168.3.15" in files_tasks_executed.keys():
                        if task_id in files_tasks_executed["cloudlet_192.168.3.15"]:
...
fig.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels, x=fix_12, orientation='h',textposition = 'outside', text=deadline_fix_12, marker_color="Green"), row=1, col=1)
fig.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels, x=dyn_12, orientation='h',textposition = 'outside', text=deadline_dyn_12, marker_color="#e64a19"), row=1, col=1)
fig.add_trace(go.Bar(name="Performance", y=y_labels, x=perf_12, orientation='h',textposition = 'outside', text=deadline_perf_12, marker_color="#1565c0"), row=1, col=1)
fig.add_trace(go.Bar(name="Local only", y=y_labels, x=local_12, orientation='h',textposition = 'outside', text=deadline_local_12, marker_color="#d81b60"), row=1, col=1)


fig.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels[:1]+y_labels[2:], x=fix_9, orientation='h',textposition = 'outside', text=deadline_fix_9, marker_color="Green", showlegend=False), row=2, col=1)
fig.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels[:1]+y_labels[2:], x=dyn_9, orientation='h',textposition = 'outside', text=deadline_dyn_9, marker_color="#e64a19", showlegend=False), row=2, col=1)
fig.add_trace(go.Bar(name="Performance", y=y_labels[:1]+y_labels[2:], x=perf_9, orientation='h',textposition = 'outside', text=deadline_perf_9, marker_color="#1565c0", showlegend=False), row=2, col=1)
fig.add_trace(go.Bar(name="Local only", y=y_labels[:1]+y_labels[2:], x=local_9, orientation='h',textposition = 'outside', text=deadline_local_9, marker_color="#d81b60", showlegend=False), row=2, col=1)

fig.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels[:1]+y_labels[3:], x=fix_6, orientation='h',textposition = 'outside', text=deadline_fix_6, marker_color="Green", showlegend=False), row=3, col=1)
fig.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels[:1]+y_labels[3:], x=dyn_9, orientation='h',textposition = 'outside', text=deadline_dyn_6, marker_color="#e64a19", showlegend=False), row=3, col=1)
fig.add_trace(go.Bar(name="Performance", y=y_labels[:1]+y_labels[3:], x=perf_6, orientation='h',textposition = 'outside', text=deadline_perf_6, marker_color="#1565c0", showlegend=False), row=3, col=1)
fig.add_trace(go.Bar(name="Local only", y=y_labels[:1]+y_labels[3:], x=local_6, orientation='h',textposition = 'outside', text=deadline_local_6, marker_color="#d81b60", showlegend=False), row=3, col=1)

fig.update_layout(barmode='group', title="Average Power Consumption (mWh) (Deadline met %)")
...
fig_1.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels, x=avg_task_execution_fix_12, orientation='h', marker_color="Green"), row=1, col=1)
fig_1.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels, x=avg_task_execution_dyn_12, orientation='h', marker_color="#e64a19"), row=1, col=1)
fig_1.add_trace(go.Bar(name="Performance", y=y_labels, x=avg_task_execution_perf_12, orientation='h', marker_color="#1565c0"), row=1, col=1)
fig_1.add_trace(go.Bar(name="Local only", y=y_labels, x=avg_task_execution_local_12, orientation='h', marker_color="#d81b60"), row=1, col=1)


fig_1.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels[:1]+y_labels[2:], x=avg_task_execution_fix_9, orientation='h', marker_color="Green", showlegend=False), row=2, col=1)
fig_1.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels[:1]+y_labels[2:], x=avg_task_execution_dyn_9, orientation='h', marker_color="#e64a19", showlegend=False), row=2, col=1)
fig_1.add_trace(go.Bar(name="Performance", y=y_labels[:1]+y_labels[2:], x=avg_task_execution_perf_9, orientation='h', marker_color="#1565c0", showlegend=False), row=2, col=1)
fig_1.add_trace(go.Bar(name="Local only", y=y_labels[:1]+y_labels[2:], x=avg_task_execution_local_9, orientation='h', marker_color="#d81b60", showlegend=False), row=2, col=1)

fig_1.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels[:1]+y_labels[3:], x=avg_task_execution_fix_6, orientation='h', marker_color="Green", showlegend=False), row=3, col=1)
fig_1.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels[:1]+y_labels[3:], x=avg_task_execution_dyn_9, orientation='h', marker_color="#e64a19", showlegend=False), row=3, col=1)
fig_1.add_trace(go.Bar(name="Performance", y=y_labels[:1]+y_labels[3:], x=avg_task_execution_perf_6, orientation='h', marker_color="#1565c0", showlegend=False), row=3, col=1)
fig_1.add_trace(go.Bar(name="Local only", y=y_labels[:1]+y_labels[3:], x=avg_task_execution_local_6, orientation='h', marker_color="#d81b60", showlegend=False), row=3, col=1)

fig_1.update_layout(barmode='group', title="Average Task Completion Time (s)")
...
fig_2.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels, x=avg_task_energy_fix_12, orientation='h', marker_color="Green"), row=1, col=1)
fig_2.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels, x=avg_task_energy_dyn_12, orientation='h', marker_color="#e64a19"), row=1, col=1)
fig_2.add_trace(go.Bar(name="Performance", y=y_labels, x=avg_task_energy_perf_12, orientation='h', marker_color="#1565c0"), row=1, col=1)
fig_2.add_trace(go.Bar(name="Local only", y=y_labels, x=avg_task_energy_local_12, orientation='h', marker_color="#d81b60"), row=1, col=1)


fig_2.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels[:1]+y_labels[2:], x=avg_task_energy_fix_9, orientation='h', marker_color="Green", showlegend=False), row=2, col=1)
fig_2.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels[:1]+y_labels[2:], x=avg_task_energy_dyn_9, orientation='h', marker_color="#e64a19", showlegend=False), row=2, col=1)
fig_2.add_trace(go.Bar(name="Performance", y=y_labels[:1]+y_labels[2:], x=avg_task_energy_perf_9, orientation='h', marker_color="#1565c0", showlegend=False), row=2, col=1)
fig_2.add_trace(go.Bar(name="Local only", y=y_labels[:1]+y_labels[2:], x=avg_task_energy_local_9, orientation='h', marker_color="#d81b60", showlegend=False), row=2, col=1)

fig_2.add_trace(go.Bar(name='Green w\ Fix Estimations', y=y_labels[:1]+y_labels[3:], x=avg_task_energy_fix_6, orientation='h', marker_color="Green", showlegend=False), row=3, col=1)
fig_2.add_trace(go.Bar(name="Green w\ Dynamic Estimations", y=y_labels[:1]+y_labels[3:], x=avg_task_energy_dyn_9, orientation='h', marker_color="#e64a19", showlegend=False), row=3, col=1)
fig_2.add_trace(go.Bar(name="Performance", y=y_labels[:1]+y_labels[3:], x=avg_task_energy_perf_6, orientation='h', marker_color="#1565c0", showlegend=False), row=3, col=1)
fig_2.add_trace(go.Bar(name="Local only", y=y_labels[:1]+y_labels[3:], x=avg_task_energy_local_6, orientation='h', marker_color="#d81b60", showlegend=False), row=3, col=1)

fig_2.update_layout(barmode='group', title="Average Task Energy Consumption (Wh)", )
...
y_labels_1 = [["d={}".format(chr(0x00D8)), "d=12", "d=9", "d=6", "d=3"],
            ['Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance"]]
y_labels_2 = [["d={}".format(chr(0x00D8)), "d=9", "d=6", "d=3"],
            ['Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance"]]
y_labels_3 = [["d={}".format(chr(0x00D8)), "d=6", "d=3"],
            ['Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance",
            'Green w\ Fix Estimations', "Green w\ Dynamic Estimations", "Performance"]]
...
fig_3.add_trace(go.Bar(name='Local', y=y_labels_1, x=distribution_local_12, orientation='h', marker_color="Green"), row=1, col=1)
fig_3.add_trace(go.Bar(name="Remote", y=y_labels_1, x=distribution_remote_12, orientation='h', marker_color="#e64a19"), row=1, col=1)
fig_3.add_trace(go.Bar(name="Cloudlet", y=y_labels_1, x=distribution_cloudlet_12, orientation='h', marker_color="#1565c0"), row=1, col=1)

fig_3.add_trace(go.Bar(name='Local', y=y_labels_2, x=distribution_local_9, orientation='h', marker_color="Green", showlegend=False), row=2, col=1)
fig_3.add_trace(go.Bar(name="Remote", y=y_labels_2, x=distribution_remote_9, orientation='h', marker_color="#e64a19", showlegend=False), row=2, col=1)
fig_3.add_trace(go.Bar(name="Cloudlet", y=y_labels_2, x=distribution_cloudlet_9, orientation='h', marker_color="#1565c0", showlegend=False), row=2, col=1)

fig_3.add_trace(go.Bar(name='Local', y=y_labels_3, x=distribution_local_6, orientation='h', marker_color="Green", showlegend=False), row=3, col=1)
fig_3.add_trace(go.Bar(name="Remote", y=y_labels_3, x=distribution_remote_6, orientation='h', marker_color="#e64a19", showlegend=False), row=3, col=1)
fig_3.add_trace(go.Bar(name="Cloudlet", y=y_labels_3, x=distribution_cloudlet_6, orientation='h', marker_color="#1565c0", showlegend=False), row=3, col=1)

fig_3.update_layout(barmode='stack', title="Execution Distribution")
