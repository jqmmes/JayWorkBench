                    ...
                    for use_calibrated in should_use_calibrated:
                        ...
                        for entry in os.listdir(base_dir):
                            ...
                            if entry.find("_{}".format(asset_type)) != -1 and conf.find(scheduler) != -1 and cloudlet_pass and use_5s_pass and use_500ms_pass and calibrated_pass:
                                ...
                                print("PROCESSING\t{}\t{}\tINTO\t{}".format(scheduler, entry ,"csv/scheduler_boxplot_{}{}{}{}{}_{}.csv".format(schedulers_translate[scheduler], cloudlet, checking_5s, checking_500ms, calibrated, asset_type)))
                                if first:
                                    os.system("python3 printJobDetails.py {}/{}/0/* > csv/scheduler_boxplot_{}{}{}{}{}_{}.csv 2> /dev/null".format(base_dir, entry, schedulers_translate[scheduler], cloudlet, checking_5s, checking_500ms, calibrated, asset_type))
                                else:
                                    os.system("python3 printJobDetails.py no-header {}/{}/0/* >> csv/scheduler_boxplot_{}{}{}{}{}_{}.csv 2> /dev/null".format(base_dir, entry, schedulers_translate[scheduler], cloudlet, checking_5s, checking_500ms, calibrated, asset_type))
            ...
            for use_500ms in should_use_500ms:
                for use_calibrated in should_use_calibrated:
                    ...
                    if use_calibrated:
                        calibrated = "_CALIBRATED"
                    for asset_type in asset_types:
                        if os.path.isfile("csv/scheduler_boxplot_{}{}{}{}{}_{}.csv".format(schedulers_translate[scheduler], cloudlet, checking_5s, checking_500ms, calibrated, asset_type)):
                            print("reading csv/scheduler_boxplot_{}{}{}{}{}_{}.csv".format(schedulers_translate[scheduler], cloudlet, checking_5s, checking_500ms, calibrated, asset_type))
                            new_data = True
                            data = pd.read_csv("csv/scheduler_boxplot_{}{}{}{}{}_{}.csv".format(schedulers_translate[scheduler], cloudlet, checking_5s, checking_500ms, calibrated, asset_type))
                    ...
                    if new_data:
                        ...
                        fig_0.add_trace(go.Box(y=data_transfer, x=group_labels, name=scheduler+cloudlet+checking_5s+checking_500ms+calibrated))
                        fig_1.add_trace(go.Box(y=image_load, x=group_labels, name=scheduler+cloudlet+checking_5s+checking_500ms+calibrated))
                        fig_2.add_trace(go.Box(y=detection, x=group_labels, name=scheduler+cloudlet+checking_5s+checking_500ms+calibrated))
                        fig_3.add_trace(go.Box(y=total, x=group_labels, name=scheduler+cloudlet+checking_5s+checking_500ms+calibrated))
                        fig_4.add_trace(go.Box(y=scheduler_decision, x=group_labels, name=scheduler+cloudlet+checking_5s+checking_500ms+calibrated))
                        fig_5.add_trace(go.Box(y=queue, x=group_labels, name=scheduler+cloudlet+checking_5s+checking_500ms+calibrated))
